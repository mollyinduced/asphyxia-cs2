...
void CPredictionSystem::Begin(CCSGOInput* pInput, CUserCmd* pUserCmd)
{
	...
	CCSPlayer_MovementServices* pMovementServices = SDK::LocalPawn->m_pMovementServices();
	...
	predictionData.flIntervalPerSubTick = I::GlobalVars->flIntervalPerSubTick;

	predictionData.flCurrentTime = I::GlobalVars->flCurrentTime;
	predictionData.flCurrentTime2 = I::GlobalVars->flCurrentTime2;
	...
	predictionData.nTickBase = SDK::LocalController->m_nTickBase();
	...
	// restore tickbase
	SDK::LocalController->m_nTickBase() = predictionData.nTickBase;
}
...
void CPredictionSystem::End(CCSGOInput* pInput, CUserCmd* pUserCmd)
{
	...
	I::GlobalVars->flIntervalPerSubTick = predictionData.flIntervalPerSubTick;

	I::GlobalVars->flCurrentTime = predictionData.flCurrentTime;
	I::GlobalVars->flCurrentTime2 = predictionData.flCurrentTime2;
