...
#include "../sdk/interfaces/networkgameservice.h"

#include "../sdk/datatypes/particle_manager.h"
...
#define INT_TO_TIME(int_) (static_cast<float>(int_) / 1000.f)
#pragma endregion
...
namespace I
{
	...
	inline INetworkClientService* NetworkClientService = nullptr; // m_network_game_service
	inline CNetworkGameClient* NetworkGameService = nullptr; // m_network_game_service
